...
function updateRestaurant() {
  ...
  xhr.open('GET', "https://developers.zomato.com/api/v2.1/search?count=1&start=1&lat=" + latitude + "&lon=" + longitude + "&radius=1000&cuisines=40&sort=real_distance&apikey=3c2968b8e9cb6e81212628d734ccb726", true)
  xhr.send();
}
...
document.getElementById("current-location-container").addEventListener("click", function(){
